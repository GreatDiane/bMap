...
package com.uzmap.pkg.uzmodules.uzBMap.clusterutil.clustering.view;
...
import com.uzmap.pkg.uzmodules.uzBMap.clusterutil.MarkerManager;
...
import com.uzmap.pkg.uzmodules.uzBMap.clusterutil.projection.Point;
import com.uzmap.pkg.uzmodules.uzBMap.clusterutil.projection.SphericalMercatorProjection;
import com.uzmap.pkg.uzmodules.uzBMap.clusterutil.ui.IconGenerator;
import com.uzmap.pkg.uzmodules.uzBMap.clusterutil.ui.SquareTextView;
...
import static com.uzmap.pkg.uzmodules.uzBMap.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, BaiduMap map, ClusterManager<T> clusterManager) {
        ...
        mIconGenerator.setTextAppearance(UZResourcesIDFinder.getResStyleID("ClusterIcon_TextAppearance"));
    ...
    private SquareTextView makeSquareTextView(Context context) {
        ...
        squareTextView.setId(UZResourcesIDFinder.getResIdID("text"));
                ...
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        if (animateFrom != null) {
                            ...
                            markerOptions.zIndex(Integer.parseInt(item.getClusterItemId()));
                        } else {
