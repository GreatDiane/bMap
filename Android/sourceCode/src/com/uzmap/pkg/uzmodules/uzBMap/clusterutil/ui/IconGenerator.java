...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        mContext = context;
        mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(UZResourcesIDFinder.getResLayoutID("text_bubble"), null);
        mRotationLayout = (RotationLayout) mContainer.getChildAt(0);
        mContentView = mTextView = (TextView) mRotationLayout.findViewById(UZResourcesIDFinder.getResIdID("text"));
    ...
    public void setContentView(View contentView) {
        ...
        final View view = mRotationLayout.findViewById(UZResourcesIDFinder.getResIdID("text"));
    ...
    private static int getTextStyle(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return UZResourcesIDFinder.getResStyleID("Bubble_TextAppearance_Dark");
            case STYLE_RED:
            case STYLE_BLUE:
            case STYLE_GREEN:
            case STYLE_PURPLE:
            case STYLE_ORANGE:
                return UZResourcesIDFinder.getResStyleID("Bubble_TextAppearance_Light");
        }
    }
}
