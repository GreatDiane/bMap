...
public class RidingRouteOverlay extends OverlayManager{
	
	private BikingRouteLine mRouteLine = null;

    public RidingRouteOverlay(BaiduMap baiduMap) {
        super(baiduMap);
    }
        ...
        if (mRouteLine.getAllStep() != null
            ...
            for (BikingRouteLine.BikingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(getLineWidth())
                            .color(getLineColor()).dottedLine(dash()).customTexture(getTextureImg()).zIndex(0));
